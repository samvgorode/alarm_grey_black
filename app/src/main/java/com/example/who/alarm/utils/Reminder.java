package com.example.who.alarm.utils;
...
public class Reminder {
    ...
    protected ContentValues mapToContentValues() {
        ...
        contentValues.put(CalendarContract.Reminders.METHOD, method == null ? CalendarContract.Reminders.METHOD_ALERT : method);
